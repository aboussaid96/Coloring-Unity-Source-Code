...
namespace PaintIn3D
{
	...
	public class P3dPaintSphere : MonoBehaviour, IHit, IHitPoint, IHitLine, IHitTriangle, IHitQuad, IHitCoord
	{
		...
		public P3dPaintableTexture TargetTexture { set { targetTexture = value; } get { return targetTexture; } } [SerializeField] public P3dPaintableTexture targetTexture;
		...
		public P3dBlendMode BlendMode { set { blendMode = value; } get { return blendMode; } } [SerializeField] public P3dBlendMode blendMode = P3dBlendMode.AlphaBlend(Vector4.one);
		...
		public Texture TileTexture { set { tileTexture = value; } get { return tileTexture; } } [SerializeField] public Texture tileTexture;

		/// <summary>This allows you to adjust the tiling position + rotation + scale using a <b>Transform</b>.</summary>
		public Transform TileTransform { set { tileTransform = value; } get { return tileTransform; } } [SerializeField] public Transform tileTransform;
